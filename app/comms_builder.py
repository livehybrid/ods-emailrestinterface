...
from app.constants import CONFIG_EMAIL_OTP_TEMPLATE_NAME, MESSAGE_FIELD_ONETIME_PASS
...
def populate_template(message):
    ...
    if MESSAGE_FIELD_ONETIME_PASS in message:
        populated_template = __populate(CONFIG_EMAIL_OTP_TEMPLATE_NAME, message)
